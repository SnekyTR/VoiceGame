...
namespace DigitalRuby.PyroParticles
{
    ...
    public delegate void MeteorSwarmCollisionDelegate1(ArrowRain script, GameObject meteor);

    /// <summary>
    /// Handles the meteor swarm effect
    /// </summary>
    public class ArrowRain : FireBaseScript, ICollisionHandler
    {
        ...
        /// </summary>
        [HideInInspector]
        public event MeteorSwarmCollisionDelegate1 CollisionDelegate;
